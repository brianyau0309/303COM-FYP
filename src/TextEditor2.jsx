...
export default class TextEditor extends React.Component {
  ...
  componentDidMount() {
    ...
    TextField2.document.execCommand("enableObjectResizing", false, false)
  }
  btnClick(event) {
    let n = null
    if (event === 'InsertOrderedList' || event === 'InsertUnorderedList') n = Math.random() * 1000
    TextField2.document.execCommand(event, false, n)
  }
  ...
  render() {
    return(
      <div className='TextEditor'>
        ...
        <iframe marginwidth="15" marginheight="10" name="TextField2" id="TextField2" onKeyUp={this.counting}></iframe>
      </div>
    )
  }
}
